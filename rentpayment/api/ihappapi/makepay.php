...
if (isset($_POST['btn-pay-rent'])) {
    ...
    if($public_id == "") { $alert = "Provide first name"; }
    elseif($appartmentprice == "") { $alert = "Provide price"; }
    elseif($appartments_id == "") { $alert = "Provide ID"; }
    elseif($month == "") { $alert = "Provide month"; }
    else
    {
      try
      {
        if($user->payment($public_id, $appartmentprice, $appartments_id, $month)){  
          $alert = "Payment made"; ?>
